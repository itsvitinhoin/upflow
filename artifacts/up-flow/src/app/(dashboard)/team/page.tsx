    ...
    <>
      ...
      <div className="p-6 max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground text-sm mt-0.5">{users.length} member{users.length !== 1 ? "s" : ""}</p>
        </div>
            ...
            <table className="w-full">
              <thead className="border-b border-border">
                <tr>
                  ...
                  <th className="text-left text-xs font-medium text-muted-foreground px-6 py-3 hidden sm:table-cell">Email</th>
